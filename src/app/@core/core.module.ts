...
import {ErrorHandlerInterceptor} from './interceptores/error-handler.interceptor';
...
import {ModalesService} from './utils/modales.service';
  ...
  ...NbAuthModule.forRoot({
    ...
    strategies: [
      NbPasswordAuthStrategy.setup({
        ...
        register: {
          endpoint: '/authentication-create',
          redirect: {
            success: '/welcome/', // welcome page path
            failure: null, // stay on the same page
          },
